...
const SALES_TABS = {
  ...
  extra: {
    label: "Porção Extra",
    singular: "Porção extra",
    flavorField: "extra_portion_flavor",
    qtyField: "extra_portion_qty",
    priceField: "extra_portion_price",
    choices: EXTRA_PORTION_FLAVORS,
    choiceLabel: "Sabor"
  }
};
